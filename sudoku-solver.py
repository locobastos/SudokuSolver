...
def resolve_sudoku_grid(verbose, grid_values, square_rows_number, square_columns_number):
    ...
    print("total_number_of_empty_boxes = " + str(total_number_of_empty_boxes))
                ...
                if grid_values[row][column] == 0:
                    ...
                    for value_to_check in values_range:
                        ...
                        if value_to_check not in values_on_the_current_square:
                            if verbose:
                                print("Yes, it is possible, so we are now adding the value " + str(value_to_check) + " to the possible list value of this box.\n") # noqa
...
resolve_sudoku_grid(False, grid_values, square_rows_number, square_columns_number)
